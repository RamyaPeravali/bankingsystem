<%@page import="com.ivy.common.model.User"%>
<%@ page import="com.ivy.common.model.listTransactions"%>
...
<body>
	...
	<form:form commandName="displDat" method="POST"
		action="/bankingsystem/displayStatement">
