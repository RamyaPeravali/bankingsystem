...
<body>
	...
	<br />
	<!--  commandName="newUser"   -->
	<form:form commandName="ccTrsc" method="POST"
		action="/bankingsystem/newCreditCardTransc">
		...
		<table>
			<tr>
				...
				<td><form:errors path="emailID" cssClass="error" />
					<div class="error">${Not_Valid_EMail}</div></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3"><input type="submit" value="Authorize" /></td>
			</tr>
		</table>
	</form:form>
